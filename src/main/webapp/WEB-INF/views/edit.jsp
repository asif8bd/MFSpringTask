...
<body>
	<h2 class="container">Spring Thymeleaf Example || Edit Student Info</h2>
	<br />
	...
	<div class="container">
		<form class="form-inline" method="post" action="edit.html?n=<%=n%>" name="myForm" onsubmit="return validateInputForm()">
